...
# Video path and name
path = os.path.abspath('TB-50')
name = 'blurbody'

# Tracker options: RCNNshift or meanshift
...
# Initialize tracker
Tracker = tracker.RCNNshift(weight=38,batch_size=50, select_tracker=select_tracker, perform=perform)
